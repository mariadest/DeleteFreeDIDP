...
def make_parser():
    ...
    # check if time solved was printed out -> needed due to issue with didppy where program doesn't stop running after printing solution
    # parser.add_pattern("solved", "solve time:", type=str, file="driver.log")      #doesn't work
    return parser
